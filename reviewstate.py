...
from cancelfunction import cancell
...
def myfunc4(st):
	...
	with open("/home/aayushman/Desktop/Review.json") as data_file:    
	...
	con,imsend=confirm(st)
	con1,imsend1=cancell(st)
	print ("expected answers")
	#print(imsend)
	state=0
	if con>counter_intro and con>con1:
		
		if len(imsend)!=0:
			retst=imsend[0]
			state=6
	elif con1>con and con1>counter_intro:
		if len(imsend1)!=0:
			retst=imsend1[0]
			state=4
			#for i in send1:	
